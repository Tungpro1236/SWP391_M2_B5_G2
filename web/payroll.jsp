...
<head>
    ...
    <style>
        ...
        /* Đảm bảo các cột có chiều cao đồng bộ */
        .form-group {
            margin-bottom: 0;
        }
        .form-group small {
            display: block;
            min-height: 1.5em; /* Đảm bảo chiều cao tối thiểu cho small */
        }
    </style>
</head>
<body>
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="teacherName" name="teacherName" placeholder="e.g., John Doe" required>
                                    
                                </div>
                            </div>
                            <div class="col-md-3">
                                <button type="submit" class="btn btn-primary w-100" onclick="return confirm('Generate payroll for this month, year, and teacher?')">Generate Payroll</button>
                            </div>
                        </div>
                    </form>
                </div>
